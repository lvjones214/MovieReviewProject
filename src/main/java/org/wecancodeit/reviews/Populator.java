...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        MovieReview movieReviewToAdd3 = new MovieReview("ScoobyDoo", family, 2018, "PG-14", "5 Stars",  "Two years later, Shaggy and Scooby are invited to solve a mystery on Spooky Island, owned by Emile Mondavarious... The gang flees, but an army of demons attacks..", "Friendship and teamwork are less important here than in other Scooby-Doo features, as the gang tries to salvage their team dynamic", "https://images.all-free-download.com/images/graphicthumb/scooby_doo_001_49750.jpg");
        movieStorage.addReview(movieReviewToAdd3);
        MovieReview movieReviewToAdd4 = new MovieReview("Aladdin", family, 2019, "PG-14", "5 Stars",  "Aladdin is a 2019 American live-action animated musical fantasy film produced by Walt Disney Pictures. Directed by Guy Ritchie.", "Aladdin is much like its protagonist..", "https://d2e111jq13me73.cloudfront.net/sites/default/files/styles/review_gallery_carousel_slide_thumbnail_landscape/public/video-thumbnails/aladdin-site1.jpg?itok=F5EbyYM9");
        movieStorage.addReview(movieReviewToAdd4);
        MovieReview movieReviewToAdd5 = new MovieReview("Step Brothers", comedy, 2008, "R", "5 Stars",  "Two aimless middle-aged losers still living at home are forced against their will to become roommates when their parents marry.", "Temp Review", "https://www.imdb.com/title/tt0838283/mediaviewer/rm3433645824");
        movieStorage.addReview(movieReviewToAdd5);
        MovieReview movieReviewToAdd6 = new MovieReview("Ace Ventura: Pet Detective", comedy, 1994 , "PG-13", "5 Stars",  "A goofy detective specializing in animals goes in search of the missing mascot of the Miami Dolphins.", "This movie was funny!", "https://www.imdb.com/title/tt0109040/mediaviewer/rm1962960640");
        movieStorage.addReview((movieReviewToAdd6));
        MovieReview movieReviewToAdd7 = new MovieReview("Freddy vs Jason", horror, 2003, "R", "5 Stars",  "Freddy Krueger and Jason Voorhees return to terrorize the teenage population. Except this time, they're out to get each other, too.", "Evil vs Evil two favorite slasher icons goes on each other Freddy vs Jason an epic battle fight. It is one of my personal favorite horror movies.", "https://www.imdb.com/title/tt0329101/mediaviewer/rm1850875392");
        movieStorage.addReview(movieReviewToAdd7);
        MovieReview movieReviewToAdd8 = new MovieReview("Get Out", horror, 2017, "R", "5 Stars",  "A young African-American visits his white girlfriend's parents for the weekend, where his simmering uneasiness about their reception of him eventually reaches a boiling point.", "The acting is wonderful, and directing is amazing.", "https://www.imdb.com/title/tt5052448/mediaviewer/rm1537293568");
